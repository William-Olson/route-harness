...
module.exports = class Harness {
  ...
  */
  configure(opts)
  {
    ...
    this._factory = opts.factory || this._factory || defaultFactory;
  }

  /*

    Factory provider for a single use harness for instance mapping all done
    in the constructor of route classes.
  ...
  */
  mountRoutes(path, mdlwr, RouteClass)
  {
    ...
    initted.wrapper.wrapRoutes(routesInstance, path, params);
  ...
  */
  use(path, mdlwr, RouteClass)
  {
    ...
    wrapper.wrapRoutes(routesInstance, path, params);
